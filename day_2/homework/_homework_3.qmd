...
6. Combine your answers to questions 1:3, including reading in the data, using pipes. Your answer should be one continuous sequence of code that reads in the data and stores the changed dataset in an object.
